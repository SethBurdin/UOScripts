...
Auto bank gold functionality. We want the script to periodically check the players current vs max weight. if at 90% capacity we will want to recall to a runebook named home and transfer the gold to an item serial we can statically set.
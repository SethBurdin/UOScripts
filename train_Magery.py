...
#                break
            ...
            if Player.Mana > spell.manaCost:
                ...
                # Use spell.delayInMs + additionalShardCooldown so higher-circle spells
                # with longer cast animations don't time out before the cursor appears
                Target.WaitForTarget( spell.delayInMs + additionalShardCooldown, True )
